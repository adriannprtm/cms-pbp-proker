        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-icon" >
                    ...
                    <img src="img/logo_himakom.png" style="max-width: 50%;">
                </div>
                <div class="sidebar-brand-text mx-3">Proker</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="/warna">Warna Aplikasi</a>
                        <a class="collapse-item" href="/onBoard">OnBoarding Page</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/categoryEvent">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
